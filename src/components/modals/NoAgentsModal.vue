<template>
  <Modal :id="'no-agents-modal'" :modal-open="modalOpen" :maxWidth="'416px'" @close-modal="close">
    <div class="p-10 relative">
      ...
      <div class="space-y-5 flex flex-col items-center">
        <div class="flex flex-col items-center space-y-2.5">
          <div class="text-xl font-bold text-gray-800 text-center">Break</div>
          <img src="@/assets/icons/bear-chill.svg" alt="">
          <div class="text-center font-medium text-gray-500">
            There are no free agents at the moment.<br />
            Come back a little later
          </div>
        </div>
        <button class="w-full h-[46px] flex items-center justify-center bg-blue-100 text-blue-500 rounded-md font-semibold hover:bg-blue-200" @click="close">
          Try again
        </button>
      </div>
    </div>
